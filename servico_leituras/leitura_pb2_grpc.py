...
import leitura_pb2 as leitura__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in leitura_pb2_grpc.py depends on'
...
class LeituraServiceStub(object):
...
class LeituraServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_LeituraServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'LeituraService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('LeituraService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class LeituraService(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def GerenciaLeituras(request,
            target,
            options=(),
